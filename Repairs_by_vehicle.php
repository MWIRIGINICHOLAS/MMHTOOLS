    ...
    <section class="forms">
        <form method="POST" action="">
            ...
            <select id="VehicleID" name="VehicleID">
                ...
                $sql = "SELECT DISTINCT VehicleID FROM repairs ORDER BY VehicleID ASC";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT Date, VehicleID, Details, 'Garage/Mechanic', Cost FROM repairs WHERE VehicleID = '$VehicleID' ORDER BY Date DESC";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($currentMonth !== $monthYear) {
                ...
                echo "<tr>
						...
						<th class='month'>Garage/Mechanic</th>
